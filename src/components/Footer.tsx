      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-lg font-semibold">ПсихоГармония</span>
            </div>
            <p className="text-muted-foreground mb-4">
              Профессиональная психологическая помощь для гармонии вашей души и разума.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start space-x-2">
                ...
                <span>г. Москва, ул. Психологов, д. 42, офис 301</span>
              </li>
              ...
              <li className="flex items-center space-x-2">
                ...
                <span>info@психогармония.рф</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/about" className="hover:text-primary transition-colors">Обо мне</Link></li>
              <li><Link to="/services" className="hover:text-primary transition-colors">Услуги</Link></li>
              <li><Link to="/blog" className="hover:text-primary transition-colors">Статьи</Link></li>
        ...
        <div className="border-t border-gray-200 mt-8 pt-8 text-center">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} ПсихоГармония. Все права защищены.
          </p>
        </div>
      </div>
    </footer>
